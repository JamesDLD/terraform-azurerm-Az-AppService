...
/**
 * For developers: WordPress debugging mode, source : https://github.com/Azure/app-service-quickstart-docker-images/blob/master/wordpress-alpine-php/0.72/wp-config.php
 *
